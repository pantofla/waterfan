<h1 class="title">{#PLIGG_Visual_Submit3_Header#}</h1>
	...
	<form action="{$URL_submit}" method="post" id="thisform" name="ATISUBMIT" >
     <fieldset>
		...
		<input type="button" onclick="gPageIsOkToExit = true; document.location.href='{$my_base_url}{$my_pligg_base}/submit.php?id='+this.form.id.value+'&trackback='+this.form.trackback.value;" value="{#PLIGG_Visual_Submit3_Modify#}" class="submit" />
