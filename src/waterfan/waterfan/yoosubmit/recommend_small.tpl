<div class="tool-show">
<h2>{#PLIGG_Visual_Recommend_FormTitle#}</h2>
	<form name="email_to" method="get" action="{$my_base_url}{$my_pligg_base}/recommend.php">
		{#PLIGG_Visual_Recommend_EnterAddress#}<br>
		<input type="text" name="email_address_1" size="35" class="text" id="email_address_1_{$link_shakebox_index}" value=""><br><br>
		<input type="text" name="email_address_2" size="35" class="text" id="email_address_2_{$link_shakebox_index}" value=""><br><br>
		<input type="text" name="email_address_3" size="35" class="text" id="email_address_3_{$link_shakebox_index}" value=""><br>
