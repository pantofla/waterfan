...
{if $pagename eq "user"}
	<div id="sidebar-right"> 
		<h3><a href="{$user_url_personal_data}">Profile Links</a></h3>
		<ul id="navlist">
...
{if $pagename eq "story" || $pagename eq "submit" || $pagename eq "search" || $pagename eq "advancedsearch"}
	<div id="sidebar-right"> 
		{include file="./templates/arthemia/ads/ad_sidebar_small.php"}
	</div>
{/if}
...
<!-- START SORT -->
	<div id="sidebar-right"> 
		<h3>{#PLIGG_Visual_Pligg_Queued_Sort#} {#PLIGG_Visual_TopUsers_TH_News#}</h3>
		<ul id="navlist">
...
{if $pagename eq "cloud"}
	<div id="sidebar-right"> 
		<h3>#PLIGG_Visual_Pligg_Queued_Sort#} {#PLIGG_Visual_Tags_Link_Summary#}</h3>
		<ul id="navlist">
...
{if $pagename eq "live" || $pagename eq "live_unpublished" || $pagename eq "live_published" || $pagename eq "live_comments"}
	<div id="sidebar-right"> 
		<h3>{#PLIGG_Visual_Pligg_Queued_Sort#} {#PLIGG_Visual_Live#}</h3>
		<ul id="navlist">
