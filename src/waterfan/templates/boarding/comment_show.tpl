...
<div class="comment-wrap">
	...
	<img src="{$my_pligg_base}/templates/thestandard/images/comment-top-main.gif" alt=""  />
	...
	{* display comment form if replying to a comment *}
		<div class="inline-comment" id="reply-{$comment_id}" style="display:none;"> 
			<fieldset><legend>{#PLIGG_Visual_Comment_Send#}</legend>
				<form action="" method="POST" id="thisform" style="display:inline;">
					...
					<textarea name="reply_comment_content-{$comment_id}" id="reply_comment_content-{$comment_id}" rows="3" cols="62"/>{$TheComment}</textarea><br/>			  
