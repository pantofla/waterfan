				...
				{checkActionsTpl location="tpl_pligg_story_votebox_start"}
					<span class="subtext" id="xvote-{$link_shakebox_index}">
						{if $link_shakebox_currentuser_votes eq 0 && $link_shakebox_currentuser_reports eq 0}
							<div style="float:left;"><a href="javascript:{$link_shakebox_javascript_vote}"><img src="{$my_pligg_base}/templates/{$the_template}/images/arrow_up.gif" alt="{#PLIGG_Visual_Vote_For_It#}" /></a></div>
							{if $link_shakebox_currentuser_votes eq 0 && $link_shakebox_currentuser_reports eq 0}
							...
							{/if}
						{else}
							<div style="float:left;"><img src="{$my_pligg_base}/templates/{$the_template}/images/arrow_up_voted.gif" alt="{#PLIGG_Visual_Vote_For_It#}" /></div>
