...
{checkActionsTpl location="tpl_pligg_profile_info_middle"}
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="names" id="names" tabindex="1" value="{$user_names}"><br />&nbsp;
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_AIM#}:</label>
			<input type="text" class="text-short"  name="aim" id="aim" tabindex="2" value="{$user_aim}">
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="email" id="email" tabindex="3" value="{$user_email}"> <br /><em>{#PLIGG_Visual_Profile_OnlyAdmins#}</em>
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_MSN#}:</label>
			<input type="text" class="text-short"  name="msn" id="msn" tabindex="4" value="{$user_msn}">
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="public_email" id="public_email" tabindex="5" value="{$user_publicemail}"><br />&nbsp;
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_Yahoo#}:</label>
			<input type="text" class="text-short"  name="yahoo" id="yahoo" tabindex="6" value="{$user_yahoo}">
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="url" id="url" tabindex="7" value="{$user_url}"><br />&nbsp;
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_GTalk#}:</label>
			<input type="text" class="text-short"  name="gtalk" id="gtalk" tabindex="8" value="{$user_gtalk}">
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="location" id="location" tabindex="9" value="{$user_location}"><br />&nbsp;
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_Skype#}:</label>
			<input type="text" class="text-short"  name="skype" id="skype" tabindex="10" value="{$user_skype}">
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<input type="text" class="text-short"  name="occupation" id="occupation" tabindex="11" value="{$user_occupation}">
		</td>
		<td align="left">
			<label for="name" accesskey="1">{#PLIGG_Visual_User_Profile_IRC#}: {#PLIGG_Visual_Profile_IRC_Instruct#}</label>
			<input type="text" class="text-short"  name="irc" id="irc" tabindex="12" value="{$user_irc}">
		</td>	
		</tr>
...
<table style="border:none">
	<tr>
		<td width="250px" align="left">
			<label>{#PLIGG_Visual_Profile_OldPass#}:</label>
			<input type="password" id="oldpassword" name="oldpassword" class="text-short" size="25" tabindex="13"/>
		</td>
		<td width="300px" align="left">
			<label>{#PLIGG_Visual_Profile_NewPass#}:</label>
			<input type="password" id="newpassword" name="newpassword" size="25" class="text-short" tabindex="14"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td align="left">
			...
			<input type="password" id="verify" name="newpassword2" size="25" class="text-short"  tabindex="15"/>
		</td>
	</tr>
