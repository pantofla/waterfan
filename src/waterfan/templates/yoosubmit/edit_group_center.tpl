...
<div class="border-sections">			<span>
...
{if $errors}<font color="red">{$errors}</font>{/if}
		<form method="POST" enctype="multipart/form-data" name="image_upload_form" action="{$edit_form_action}">
			...
			<input type="text" name="group_title" class="text-long" id="group_title" value="{$group_name}" /><br/>
			<br/>
			...
			<input type="text" class="text" id="group_vote_to_publish" size="4" name="group_vote_to_publish" value="{$group_vote_to_publish}"><br /><br />
