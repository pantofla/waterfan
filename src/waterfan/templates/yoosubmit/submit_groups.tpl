...
<div class="border-sections">
	...
	<form action="{$URL_submit_groups}" method="post" name="thisform" id="thisform" enctype="multipart/form-data">
		<label>{#PLIGG_Visual_Submit_Group_Title#}:</label>{#PLIGG_Visual_Group_Submit_TitleInstruction#}<br/>
		<input type="text" id="group_title" class="text-long" name="group_title" value="{$templatelite.post.group_title}" size="60" maxlength="120" />
	<br/>	<br/>
		<label>{#PLIGG_Visual_Submit_Group_Description#}:</label>{#PLIGG_Visual_Group_Submit_DescriptionInstruction#}<br/>
		...
		<label>{#PLIGG_Visual_Submit_Group_Privacy#}: &nbsp;</label>
			...
			<br/><br/>{#PLIGG_Visual_Group_Submit_PrivacyInstruction#}<br/>
		...
		<label>{#PLIGG_Visual_Submit_Group_Mail_Friends#}:</label>
		{#PLIGG_Visual_Group_Submit_Mail_Friends_Desc#}<br/>
		<textarea type="text" id="group_mailer" rows="4" cols="60" name="group_mailer" >{$templatelite.post.group_mailer}</textarea><br /><br />
		<label>{#PLIGG_Visual_Submit_Group_vote_to_publish#}:</label>{#PLIGG_Visual_Group_Submit_NoOfVoteInstruction#}<br/>
		<input type="text" id="group_vote_to_publish" class="text" size="4" name="group_vote_to_publish" value="{$templatelite.post.group_vote_to_publish}"><br /><br />
