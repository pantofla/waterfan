 ...
 <fieldset>
	<table width="500">
			...
			<td valign="top">
				...
				{$comments}
				<hr/>
				<a href="{$URL_story, $link_id}" rel="width:800,height:700" class="mb" title="Latest Submission">{$link_date}</a> <br/>
				<a href="{$URL_story, $link_id}#c{$comment_id}" rel="width:800,height:700" class="mb"  title="Latest Comment">{if isset($comment_date)}{$comment_date}{/if}</a> <br/>
				<a href="{$URL_user, $last_user}" rel="width:800,height:700" class="mb" title="{$last_user}'s Profile">{$last_user}</a>
			</td>	
			</tr>
