<h1 class="title">{#PLIGG_Visual_Profile_ModifyProfile#}</h1>
...
{checkActionsTpl location="tpl_pligg_profile_info_start"}
	{if $UseAvatars neq false}
		<h4>{#PLIGG_Visual_Profile_UploadAvatar2#}:</h4>
	...
	{if $UseAvatars neq false}
			...
			<input type=submit name="save_profile" value="{#PLIGG_Visual_Profile_Save#}" class="submit">
	{/if}
...
<h4>{#PLIGG_Visual_Profile_ChangePass#}</h4>
...
{checkActionsTpl location="tpl_pligg_profile_end"}
<input type="submit" name="save_profile" value="{#PLIGG_Visual_Profile_Save#}" class="submit" tabindex="16">
