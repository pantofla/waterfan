<div class="clearfloat" id="xnews-{$link_shakebox_index}" {if $link_shakebox_currentuser_reports gt 0} style="opacity:0.3;filter:alpha(opacity = 30)"{/if}>
	{checkActionsTpl location="tpl_pligg_story_start"}

	<h3 class="cat_title">
		<a href="{$category_url}">{$link_category}  &raquo;</a>
	</h3>
	...
	{if $Voting_Method eq 1}
		<div class="vote">
			{checkActionsTpl location="tpl_pligg_story_votebox_start"}
				...
				<div class="votetext"><span class="subtext" id="xvote-{$link_shakebox_index}">
			...
			{if $enable_tags}
				{if $tags}
					...
					{section name=thistag loop=$tag_array}
						{if $tag_array[thistag] ne #PLIGG_Visual_Tags_All_Tags# && $tag_array[thistag] neq ''}
...
var addthis_brand = "waterfangeeks.eu";
...
{include file=$the_template."/ads/ads.tpl"}
...
/* 728x90, &#948;&#951;&#956;&#953;&#959;&#965;&#961;&#947;&#942;&#952;&#951;&#954;&#949; 29/12/2009 */
google_ad_slot = "3797595158";
google_ad_width = 728;
google_ad_height = 90;
//-->
</script>
