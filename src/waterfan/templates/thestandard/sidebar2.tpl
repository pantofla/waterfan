{checkActionsTpl location="tpl_pligg_sidebar_start"}
	...
	{* Please keep in the advertisement banner to support the template developer.
       If you wish to remove it please consider making a donation to Pligg CMS. *}
	   
	<div style="margin:25px 0px 10px 28px;border:2px solid #bbb;width:220px;">
		{php}
			srand((float) microtime() * 10000000);
			// Create the array
			$images = array();
			$images[] = array('image'  => 'http://www.pligg.com/redo/images/banner_donate.jpg',
							  'link' => 'http://forums.pligg.com/donate/',
							  'title' => 'Donate to Pligg CMS');
			$images[] = array('image'  => 'http://www.pligg.com/redo/images/banner_godaddy.jpg',
							  'link' => 'http://www.pligg.com/blog/140/godaddy-discount-promo-codes/',
							  'title' => 'GoDaddy Domain Coupon Codes');
			$images[] = array('image'  => 'http://www.pligg.com/redo/images/banner_dreamhost.jpg',
							  'link' => 'http://www.pligg.com/dreamhost/',
							  'title' => 'Dreamhost Web Hosting');

			$rand_key = array_rand($images, 1);
			$image_array = $images[$rand_key];
			$image = $image_array['image'];
			$link = $image_array['link'];
			$title = $image_array['title'];
			echo '<a href="' .$link. '"><img src="' .$image. '" title="' .$title. '" alt="' .$title. '" /></a>';
		{/php}
	</div>
	
	<p style="text-align:center;font-size:10px;">More <a href="http://www.pligg.com/hosting.php">Web Hosting Coupon Codes</a></p>
