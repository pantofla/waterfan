...
<fieldset><legend><img src="{$my_pligg_base}/templates/admin/images/manage_rss.gif" align="absmiddle"/> {#PLIGG_RSS_Import#}</legend>

<br />
<img src="{$my_pligg_base}/templates/admin/images/feed_add.gif" align="absmiddle"/> 
...
<h2>Edit the feed</h2>	
  <b><img src="{$my_pligg_base}/templates/admin/images/feed_bullet.gif" align="absmiddle"/> Feed Name: </b> <span class="emptytext">{eipItem 
item=qeip_FeedName unique=$feed_id ShowJS=TRUE}</span><br>
	...
	<img src= "{$my_pligg_base}/templates/admin/images/feed_delete.gif" align="absmiddle"/> 
	<a href = "module.php?module=rss_import&action=dropfeed&feed_id={$feed_id}" onClick="return verify()">
	Delete this feed</a>

	<br />
	<img src="{$my_pligg_base}/templates/admin/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import&action=exportfeed&feed_id={$feed_id}">Export this feed</a>
	<br />
	<img src="{$my_pligg_base}/templates/admin/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import&action=examinefeed&feed_id={$feed_id}">Examine this feed</a>
	<br>
	<img src="{$my_pligg_base}/templates/admin/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import_do_import&override={$feed_id}">Import this feed</a>
	<br><br>
