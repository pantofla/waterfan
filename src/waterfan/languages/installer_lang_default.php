...
// Upgrade
	...
	$lang['UpgradeHome'] = 'This will upgrade the database for Pligg Beta v9.0 and above to the latest version.<br /><br /><b>Note:</b> this is just a database upgrade, you still need to upload the new files.<br />';
	$lang['UpgradeAreYouSure'] = 'Are you sure you wish to upgrade you database?';
	$lang['UpgradeYes'] = 'Yes';
